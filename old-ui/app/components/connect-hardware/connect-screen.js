        ...
        return (
            <div className="new-account-connect-form unsupported-browser">
                <div className="hw-connect">
                    ...
                    <p className="hw-connect__msg">You need to use TomoMask on Google Chrome in order to connect to your Hardware Wallet.</p>
                </div>
                <Button
                    type="primary"
                    large={true}
    ...
    renderHeader () {
        return (
            <div className="hw-connect__header">
                <p className="hw-connect__header__msg">{`Select a hardware wallet you'd like to use with TomoMask`}</p>
            </div>
        )
    }
