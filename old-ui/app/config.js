...
ConfigScreen.prototype.render = function () {
  ...
  return (
    h('.flex-column.flex-grow', {
      ...
      backgroundImage: 'radial-gradient(farthest-side at 10% 0px, rgb(255, 255, 255) 0%, rgb(247, 247, 247) 300px',
      boxShadow: 'rgb(78, 78, 78) 0px 8px 16px 0px',
      margin: '0px 4px 12px',
      borderRadius: '10px'
          },
        }, [
              ...
              onClick (event) {
                window.logStateString((err, result) => {
                  if (err) {
                    ...
                    exportAsFile('TomoMask State Logs.json', result)
                  }
                })
              },
            }, 'Download State Logs'),
