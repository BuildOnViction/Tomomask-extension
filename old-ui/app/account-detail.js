      ...
      h('.account-data-subsection', {
        ...
        h('.flex-row', {
          ...
          !ifContractAcc(currentKeyring) ? h('button', {
            ...
            style: { marginRight: '10px', width: '93px', height: '31px', boxShadow: 'rgba(13, 28, 88) 0px 5px 10px 0px', color: '#f1ecff' },
          }, 'Buy') : null,

          h('button', { style: { marginRight: '-13px', width: '93px', height: '31px', boxShadow: 'rgba(27, 8, 153, 0.3) 0px 5px 10px 0px', color: 'rgb(53, 27, 93)' },
            onClick: () => {
