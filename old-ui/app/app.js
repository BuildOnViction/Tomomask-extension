  ...
  return (
    h('.flex-column.full-height', {
      ...
      h('.app-primary' + (transForward ? '.from-right' : '.from-left'), {
        style: {
          background: (props.isUnlocked || props.currentView.name === 'restoreVault' || props.currentView.name === 'config') ? confirmMsgTx ? 'linear-gradient(rgb(84, 36, 147), rgb(104, 45, 182))' : '' : 'transparent',
  ...
  switch (props.currentView.name) {
    ...
    case 'qr':
      ...
      return h('div', {
        ...
        backgroundImage: 'radial-gradient(farthest-side at 30% 0px, #399bb9 0%, #03036d 300px)',
