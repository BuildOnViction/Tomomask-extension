...
const {
  ...
  RINKEBY_CODE,
  KOVAN_CODE,
  TOMO_TESTNET_CODE} = require('../controllers/network/enums')
...
function getExchanges ({network, amount, address}) {
  ...
  switch (networkID) {
    ...
    case TOMO_CODE:
      return [{
        name: 'KuCoin - TOMO / ETH',
        link: 'https://www.kucoin.com/trade/TOMO-ETH'
    }, {
      name: 'Hotbit - TOMO / ETH',
      link: 'https://www.hotbit.io/exchange?symbol=TOMO_ETH'
    }, {
      name: 'Vinex - TOMO / ETH',
      link: 'https://vinex.network/market/ETH_TOMO'
    }, {
      name: 'Gate.io - TOMO / ETH',
      link: 'https://gate.io/trade/tomo_eth'
    }, {
    name: 'DDEX - TOMO / ETH',
    link: 'https://ddex.io/trade/TOMO-WETH'
