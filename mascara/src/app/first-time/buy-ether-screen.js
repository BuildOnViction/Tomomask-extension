      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">(This is the account address that TomoMask created for you to recieve funds.)</div>
            <div className="buy-ether__buttons">
              <button
                className="first-time-flow__button"
  ...
  render () {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__body-text">
          TomoMask works best if you have Ether in your account to pay for transaction gas fees and more. To get Ether, choose from one of these methods.
        </div>
