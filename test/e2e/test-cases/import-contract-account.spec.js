  ...
  describe('Simple contract', async () => {
    ...
    describe('Import Contract', async () => {
      ...
      it("Warning's  text is correct", async () => {
        ...
        assert.equal(await field.getText(), 'Imported accounts will not be associated with your originally created TomoMask account seedphrase.', "incorrect warning's text")
      })
